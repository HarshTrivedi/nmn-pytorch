...
annotation_file = os.path.join(
    root_dir, 'raw_data/Annotations/v2_mscoco_%s_annotations.json' % image_set)

with open(annotation_file) as f:
    annotations = json.load(f)["annotations"]

with open(os.path.join(root_dir,
                       'preprocessed_data/vqa_answers_original.txt')) as f:
...
with open(os.path.join(root_dir, 'preprocessed_data/vqa_answers.txt'),
          'w') as f:
