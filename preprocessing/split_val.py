...
val_questions['questions'] = [ question for question in questions['questions']  if question['question_id'] in val_qids]
test_questions['questions'] = [ question for question in questions['questions']  if question['question_id'] in test_qids]

val_annotations['annotations'] = [ annotation for annotation in annotations['annotations']  if annotation['question_id'] in val_qids]
test_annotations['annotations'] = [ annotation for annotation in annotations['annotations']  if annotation['question_id'] in test_qids]
...
image_feature_dir  = os.path.join(  root_dir, 
            'preprocessed_data/image_features/%s/' % test_set )
