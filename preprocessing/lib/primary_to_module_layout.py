...
def parse_to_layout(parse):
    ...
    conjunctions = ["and"]
    transforming_adjectives = [
        "in", "on", "above", "below", "besides", "over", "beside", "through",
        "inside", "out_of", "at", "with", "behind", "on_top_of", "next_to",
        "outside_of", "into", "between", "around", "toward", "towards", "under",
        "within", "in_front_of", "near", "nearest", "without", "because_of",
        "like", "along", "about", "against"
    ]
    ...
    with open(sys.argv[1]) as f:
        for line in f.readlines():
            ...
            if parse_group != "":
                ...
                parses = [("what", "thing") if p == "none" else p
                          for p in parses]
