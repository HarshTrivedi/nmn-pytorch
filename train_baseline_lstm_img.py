    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for batch_index, batch_datums in enumerate(
                ...
                model.lstmModel.hidden = model.lstmModel.init_hidden(
                )  # you must do this!
                if use_gpu:
                    image_feat = Variable(
                ...
                prediction_scores_tensor = model.forward(
                    image_feat, token_sequence_tensor)
...
def test_model(model, datasetloader, dataset):
    ...
    for batch_index, batch_datums in enumerate(datasetloader):
        ...
        prediction_scores_tensor = model.forward(image_feat,
...
if __name__ == "__main__":
    ...
    ######
    # change this block Model Wise
    model = VGABaseModel(D_img, D_txt, D_map, D_hidden,
