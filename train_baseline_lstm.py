from baseline_lstm_model import *
...
train_results_file = os.path.join( results_dir, model_name + '.json' )
val_results_file  = os.path.join( results_dir, model_name + '.json' )
...
######
# change this block Model Wise
model = LSTMModel(question_word_embeddings_np, 
                  D_txt, 
                  D_map, 
                  D_hidden, 
                  question_vocab_size,  
