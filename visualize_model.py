...
if model_name == 'cmp_nn_vqa':
    train_cmp_nn_vqa.visualize_model(vqa_model, test_dataloader, test_dataset, num_questions, False)

elif model_name == 'baseline_lstm_img':	
    baseline_lstm_img.visualize_model(vqa_model, test_dataloader, test_dataset, num_questions, False)

elif model_name == 'baseline_lstm':
    baseline_lstm.visualize_model(vqa_model, test_dataloader, test_dataset, num_questions, False)
